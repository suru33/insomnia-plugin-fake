...
exports.employment = {
  ...
  run: async (context, key) => {
    switch (key) {
      case "jobArea": return faker.name.jobArea();
      case "jobDescriptor": return faker.name.jobDescriptor();
      case "jobTitle": return faker.name.jobTitle();
      case "jobType": return faker.name.jobType();
      default: return "UNKNOWN-EMPLOYMENT-CATEGORY";
    }
  }
};
