...
exports.finance = {
  name: "fakeFinance",
  displayName: "Fake Finance",
  description: "Get fake finance",
  args: [{
  ...
  run: async (context, key) => {
    switch (key) {
      ...
      case "bic": return faker.finance.bic({ includeBranchCode: false });
      case "bicLong": return faker.finance.bic({ includeBranchCode: true });
      ...
      case "currencySymbol": return faker.finance.currencySymbol();
      case "ethereumAddress": return faker.finance.ethereumAddress();
      case "litecoinAddress": return faker.finance.litecoinAddress();
      case "pin4": return faker.finance.pin();
      case "pin6": return faker.finance.pin(6);
      ...
      default: return "UNKNOWN-FINANCE-CATEGORY";
    }
  }
};

exports.financeIBAN = {
  name: "fakeFinanceIBAN",
  displayName: "Fake IBAN",
  description: "Get fake IBAN",
  args: [
    {
      displayName: "Country",
      type: "enum",
  ...
  run: async (context, country, formatted) => faker.finance.iban(formatted, country)
};

exports.financeAccountNumber = {
  name: "fakeBankAccountNumber",
  displayName: "Fake Bank Account Number",
  description: "Get fake bank account number",
  args: [
    {
  ...
  run: async (context, length) => faker.finance.account(length < 5 || length > 15 ? 8 : length)
};
