...
exports.science = {
  ...
  run: async (context, key) => {
    switch (key) {
      case "element": return faker.science.chemicalElement().name;
      case "elementSymbol": return faker.science.chemicalElement().symbol;
      case "unit": return faker.science.unit().name;
      case "unitSymbol": return faker.science.unit().symbol;
      default: return "UNKNOWN-SCIENCE-CATEGORY";
    }
  }
};
