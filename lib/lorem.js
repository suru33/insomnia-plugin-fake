...
exports.lorem = {
    ...
    run: async (context, key, size) => {
        switch (key) {
            case 'lines':
                return faker.lorem.lines(size);
            case 'paragraph':
                return faker.lorem.paragraph(size);
            case 'paragraphs':
                return faker.lorem.paragraphs(size);
            case 'sentence':
                return faker.lorem.sentence(size);
            case 'sentences':
                return faker.lorem.sentences(size);
            case 'slug':
                return faker.lorem.slug(size);
            case 'text':
                return faker.lorem.text();
            case 'word':
                return faker.lorem.word({length: size, strategy: 'any-length'});
            case 'words':
                return faker.lorem.words(size);
            default:
                return 'UNKNOWN-LOREM-OPTION';
        }
    }
}
